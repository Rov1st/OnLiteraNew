    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $user->name)"
                required readonly autocomplete="name" />
        ...
        <div>
            ...
            <x-text-input id="display_name" name="display_name" type="text" class="mt-1 block w-full"
                :value="old('display_name', $user->display_name)" required autofocus autocomplete="display_name" />
        ...
        <div>
            ...
            <x-text-input id="NISN" name="NISN" type="text" class="mt-1 block w-full"
                :value="old('NISN', $user->NISN)" required autofocus autocomplete="NISN" />
